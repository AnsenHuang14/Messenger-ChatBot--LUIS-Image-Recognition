...
namespace Imago.Media
{
    ...
    public class AudioFileFormatConverter
    {
        ...
        /// <param name="targetPath">The foldFer where the converted files will be stored.</param>
        ...
        public string ConvertMP4ToWAV()
        {
           ...
           // var inputFile = new MediaFile { Filename = SourceFileNameAndPath };
            ...
            (new NReco.VideoConverter.FFMpegConverter()).ConvertMedia(SourceFileNameAndPath, ConvertedFileNameAndPath,"wav"); 
        ...
        {
            return "D:" + @"\" + "home" + @"\" + "site" + @"\" + "wwwroot" + @"\" + "bin" + @"\"+ "mp4towav"+@"\"+"bin"+@"\" + "ffmpeg.exe";
